...
const RankingContent: React.FC<RankingContentProps> = ({
  ...
  // FIXED: Show loading state when switching categories or initially loading
  if (isLoading && !data) {
    return (
  ...
  // Show loading during refresh only
  if (isLoading && data) {
    return (
      <View style={styles.centerContainer}>
    ...
    <View style={styles.contentContainer}>
      ...
      >
        <View style={styles.rankingsContainer}>
          {data.rankings
            .slice(0, 15) // Show first 15 for testing
        ...
        {/* User's rank (if not in top 15) */}
        {data.userRank && data.userRank.rank > 15 && (
